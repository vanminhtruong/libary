                ...
                <div className="relative flex-shrink-0 w-full md:w-32 h-40 md:h-auto cursor-pointer" onClick={() => navigate(`/books/${borrowing.book.id}`)}>
                    ...
                    <div className="absolute top-2 right-2">
                        <Tag 
                            ...
                            severity={borrowing.status === 'active' ? (statusInfo.label === t('borrowings.overdue') ? 'warning' : 'success') : 
                ...
                <div className="flex-1 flex flex-col">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mb-3 text-sm">
                        ...
                        <div>
                            ...
                            <div className={`font-semibold ${statusInfo.label === t('borrowings.overdue') ? 'text-orange-600 dark:text-orange-400' : 'text-gray-800 dark:text-gray-200'}`}>
                                {formattedDueDate}
                            </div>
                        </div>
                    ...
                    <div className="mt-auto flex flex-wrap gap-2">
                        ...
                        {statusInfo.label === t('borrowings.overdue') && (
                            <Button 
                                icon="pi pi-dollar" 
                                label={t('borrowings.view_fines')}
                                className="p-button-sm p-button-warning p-button-outlined" 
                                onClick={() => onViewFines(borrowing)}
                            />
                        )}
                        
                        <Button
                            icon="pi pi-ellipsis-v"
                            className="p-button-sm p-button-text p-button-rounded ml-auto"
                            onClick={toggleMenu}
                            aria-label="Options"
                        />
